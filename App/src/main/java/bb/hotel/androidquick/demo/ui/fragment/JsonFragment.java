...
import bb.hotel.androidquick.demo.bean.FuliBean;
import bb.hotel.androidquick.demo.bean.GankFuliBean;
import bb.hotel.androidquick.demo.network.GankRes;
import bb.hotel.androidquick.demo.tool.FastJsonHelper;
import bb.hotel.androidquick.tool.GsonHelper;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_tools_gsonhelper_common:
                ...
                GankFuliBean gsonObj1 = GsonHelper.fromJson(testJsonString, GankFuliBean.class);
                List<GankFuliBean.FuliBean> fulis =  gsonObj1.getResults();
                String desc = " ";
